...
def execute(conn, inputs, params, outputs, reportFileName):
    ...
    model = LogisticRegression(multi_class=params['multi_class'], solver=params['solver'], penalty=params['penalty'],
                               C=float(params['C']), tol=float(params['tol']), class_weight=class_weight,
                               random_state=random_state, max_iter=int(params['max_iter']))
